...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if (tariffRepository.count() == 0) {
            ...
            tariffRepository.saveAll(List.of(daily));
        ...
        if (bikeRepository.count() == 0) {
            ...
            Bike bike1 = new Bike(null, "Trek Madone SLR 9", BikeType.ROAD, BikeStatus.AVAILABLE, dailyTariff,
            ...
            Bike bike2 = new Bike(null, "Merida NINETY-SIX 9000", BikeType.MOUNTAIN, BikeStatus.AVAILABLE, dailyTariff,
            ...
            Bike bike3 = new Bike(null, "Canyon Commuter mid-step ", BikeType.CITY, BikeStatus.AVAILABLE, dailyTariff,
            ...
            Bike bike4 = new Bike(null, "Santa Cruz v10", BikeType.MOUNTAIN, BikeStatus.AVAILABLE, dailyTariff,
                    List.of(new Image("https://bikebrothers.es/435-home_default/santa-cruz-v-cc-kit-dh-x.jpg", true)));
            Bike bike5 = new Bike(null, "Trek Domane AL 2", BikeType.ROAD, BikeStatus.MAINTENANCE, dailyTariff,
